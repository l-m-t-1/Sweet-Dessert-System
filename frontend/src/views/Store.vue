  ...
  <div class="store-page">
    ...
    <section class="catalog">
      <div class="catalog-head">
        ...
        <el-input v-model="keyword" clearable placeholder="搜索甜品" class="search" @input="load" />
      </div>
...
async function load() {
  loading.value = true
  try {
    const result = await pageStoreDesserts({ page: page.value, size, name: keyword.value || undefined })
